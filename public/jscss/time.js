function showTime() { 
	...
	var startDate = new Date(2015, 4, 28);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear Xin:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----zhang chenyue   2018-09-28</c>";
