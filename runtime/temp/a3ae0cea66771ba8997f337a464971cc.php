<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"D:\wamp64\www\yyy.com\public/../application/index\view\user\user.html";i:1538286461;s:66:"D:\wamp64\www\yyy.com\public/../application/index\view\header.html";i:1536904258;s:66:"D:\wamp64\www\yyy.com\public/../application/index\view\footer.html";i:1533704758;s:65:"D:\wamp64\www\yyy.com\public/../application/index\view\share.html";i:1534127867;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<body style="position:relative;">
    ...
    <div class="m-head">
        ...
        <a href="javascript:;" class="head-info" style="display: none">
            <i class="fa fa-envelope"></i>
        </a>
        <a href="<?php echo url('index/user/xiaoxilog'); ?>" class="nav-link" ><span class="xiaoxi">消息</span><span class="nav-counter nav-counter-blue" id="count"><?php echo $count; ?></span></a>
        <!--<a href="http://kf.workerman.net" web-id="baidu.com" id="workerman-kefu">在线客服</a>-->
    ...
    <div class="m-user">
        <!--头像信息-->
        <div class="user-hdinfo">
            <a href="<?php echo url('/index/user/myinfo'); ?>" class="hdinfo-img">
                <img src="<?php if(!empty($member['avatar'])) echo imgUrl($member['avatar']);else echo imgUrl('') ?>" />
            </a>
            <div class="hdinfo-name"><span><?php echo $member['username']; ?></span><u>（<?php echo $member['mobile']; ?>）</u></div>
            <ul class="hdinfo-money">
                <li>
                    <span onclick="window.location='<?php echo url('/index/user/wallet'); ?>'"><?php echo $member['credit']; ?></span>
                    <p>余额（元）</p>
                </li>
                <li>
                    <span onclick="window.location='<?php echo url('/index/user/sheepfold'); ?>'"><?php echo $lambnum; ?></span>
                    <p>羊羊（只）</p>
                </li>
            </ul>
        </div>
        <!--头像信息结束-->
        <!--功能列表-->
        <ul class="user-ftlist">
           <?php if($member['is_agent'] == 1): ?>
            <li>
                <a href="<?php echo url('/index/user/agentlist'); ?>">
                    <i class="fa fa-book ftlist-icon"></i>
                    <span>代理证书</span>
                    <i class="fa fa-angle-right ftlist-enter"></i>
                </a>
            </li>
            <?php endif; ?>
            <li>
                <a href="<?php echo url('/index/user/photograph'); ?>">
                    <i class="fa fa-play ftlist-icon"></i>
                    <span>摄影大赛</span>
                    <i class="fa fa-angle-right ftlist-enter"></i>
                </a>
            </li>
            <li>
                <a href="<?php echo url('/index/shop/glist'); ?>">
                    <i class="fa fa-shopping-cart ftlist-icon"></i>
                    <span>我要领羊</span>
                    <i class="fa fa-angle-right ftlist-enter"></i>
                </a>
            </li>
            <li>
                <a href="<?php echo url('/index/user/wallet'); ?>">
                    <i class="fa fa-jpy ftlist-icon"></i>
                    <span>我的钱包</span>
                    <i class="fa fa-angle-right ftlist-enter"></i>
                </a>
            </li>
<!--            <li>
                <a href="javascript:;">
                    <i class="fa fa-database ftlist-icon"></i>
                    <span>我的积分</span>
                    <i class="fa fa-angle-right ftlist-enter"></i>
                </a>
            </li>-->
            <li>
                <a href="<?php echo url('/index/user/sheepfold'); ?>">
                    <i class="fa fa-flag ftlist-icon"></i>
                    <span>我的羊圈</span>
                    <i class="fa fa-angle-right ftlist-enter"></i>
                </a>
            </li>
            <li>
                <a href="<?php echo url('/index/user/coupon'); ?>">
                    <i class="fa fa-ticket ftlist-icon"></i>
                    <span>我的优惠券</span>
                    <i class="fa fa-angle-right ftlist-enter"></i>
                </a>
            </li>
<!--            <li>
                <a href="<?php echo url('/index/user/recommend'); ?>">
                    <i class="fa fa-heart ftlist-icon"></i>
                    <span>推荐记录</span>
                    <i class="fa fa-angle-right ftlist-enter"></i>
                </a>
            </li>-->
            <li>
                <a href="<?php echo url('/index/user/invite'); ?>">
                    <i class="fa fa-group ftlist-icon"></i>
                    <span>邀请好友</span>
                    <i class="fa fa-angle-right ftlist-enter"></i>
                </a>
            </li>
            <li>
                <a href="<?php echo url('/index/user/myorder'); ?>">
                    <i class="fa fa-th-list ftlist-icon"></i>
                    <span>我的订单</span>
                    <i class="fa fa-angle-right ftlist-enter"></i>
                </a>
            </li>
            <li>
                <a href="<?php echo url('/index/user/protocollist'); ?>">
                    <i class="fa fa-file-text ftlist-icon"></i>
                    <span>我的合同 </span>
                    <?php if($protocolcount > 0): ?><span class="nav-counter nav-counter-blue" id="protocol"> 待签：<?php echo $protocolcount; ?></span><?php endif; ?>
                    <i class="fa fa-angle-right ftlist-enter"></i>
                </a>
            </li>
            <li>
                <a href="<?php echo url('/index/user/exchange'); ?>">
                    <i class="fa fa-align-justify ftlist-icon"></i>
                    <span>兑换记录</span>
                    <i class="fa fa-angle-right ftlist-enter"></i>
                </a>
            </li>
            <li>
                <a href="<?php echo url('/index/user/contactus'); ?>">
                    <i class="fa fa-phone-square ftlist-icon"></i>
                    <span>联系我们</span>
                    <i class="fa fa-angle-right ftlist-enter"></i>
                </a>
            </li>
            <li>
                <a href="<?php echo url('/index/mall/mall'); ?>">
                    <i class="fa fa-shopping-cart ftlist-icon"></i>
                    <span>积分商城</span>
                    <i class="fa fa-angle-right ftlist-enter"></i>
                </a>
            ...
            <li>
                <a href="<?php echo url('/index/user/address'); ?>">
                    <i class="fa fa-map-marker ftlist-icon"></i>
                    <span>收货地址</span>
                    <i class="fa fa-angle-right ftlist-enter"></i>
                </a>
            </li>
            <li>
                <a href="<?php echo url('/index/user/setup'); ?>">
                    <i class="fa fa-cog ftlist-icon"></i>
                    <span>帐号安全</span>
                    <i class="fa fa-angle-right ftlist-enter"></i>
                </a>
            </li>
            ...
            <li id="isapp">
                <a href="<?php echo url('/index/login/login',array('exit'=>1)); ?>">
                    <i class="fa fa-minus-circle  ftlist-icon"   style="color: #ED5A98;"></i>
                    <span>退出</span>
                    <i class="fa fa-angle-right ftlist-enter"></i>
                </a>
            </li>
    ...
    <script>
        function appback() {
            ...
            if (str == 'oioos_webkit_android') {
                if (typeof oioos != 'undefined') {
                    ...
                    setTimeout(function(){window.location.href = 'http://yang.oioos.com'},2000);
                ...
                window.location.href = 'ios://logout_by_weixin';
                $.ajax({
                    type :"get",
                    async :false, //同步请求
                    url : "<?php echo url('index/login/login'); ?>",
...

        {
            ...
            $.ajax({
                type :"post",
                async :false, //同步请求
                url : "<?php echo url('index/user/ajaxxiaoxi'); ?>",
                timeout:1000,
                success:function(dates){
                    $("#count").html(dates);//要刷新的div
                },
                error:function() {
                    // alert("失败，请稍后再试！");
                }
