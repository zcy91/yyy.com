<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"E:\phpStudy\WWW\yyy.com\public/../application/index\view\index\ajaxnotice.html";i:1523001918;}*/ ?>
...
<div class="m-questions" id="comList" style="padding-top:0;padding-bottom: 0">
    <ul style="padding-top: 0;">
        ...
        <li ">
            <a href="<?php echo url('/index/index/notice_detail',array('id'=>$vo['id'])); ?>" style="white-space: nowrap;display: block;overflow: hidden;text-overflow: ellipsis;width: 100%;"><?php echo $k+($p-1)*$page_count; ?>、<?php echo $vo['title']; ?></a>
        </li>
