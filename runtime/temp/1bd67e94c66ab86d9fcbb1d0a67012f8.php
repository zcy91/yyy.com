<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"E:\phpStudy\WWW\yyy.com\public/../application/back\view\article\touradd.html";i:1526630186;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
		...
		<div class="larry-personal-body clearfix">
			<form class="layui-form col-lg-5" enctype="multipart/form-data" id="add_comment" method="post">
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						...
						<input type="hidden" name="id" value="<?php if(!empty($myarticle['id'])): ?><?php echo $myarticle['id']; endif; ?>" >
                                ...
                                <div class="layui-form-item">
					<label class="layui-form-label">旅游线路</label>
					<div class="layui-input-block">
				...
				<div class="layui-form-item" style="width: 1100px">
					<label class="layui-form-label">旅游时间</label>
					<div class="layui-input-block">

						<div class="" id="alisth_0" style="margin-bottom: 10px">
							队伍编号：<input type="text" class="layui-input" style="width: 50px" name="ladder_num[]" <?php if(!empty($myarticle['price_ladder'])): ?>value="<?php echo $myarticle['price_ladder'][0]['num']; ?>"<?php endif; ?>>
							抵达日期：<input type="text" class="layui-input" name="ladder_arrive[]" <?php if(!empty($myarticle['price_ladder'])): ?>value="<?php echo $myarticle['price_ladder'][0]['arrive']; ?>"<?php endif; ?>  style="width: 100px;" >&nbsp;
							游玩日期：<input type="text" class="layui-input" name="ladder_play[]" <?php if(!empty($myarticle['price_ladder'])): ?>value="<?php echo $myarticle['price_ladder'][0]['play']; ?>"<?php endif; ?>  style="width: 200px;" >&nbsp;
							返程时间：<input type="text" class="layui-input" name="ladder_back[]"  <?php if(!empty($myarticle['price_ladder'])): ?>value="<?php echo $myarticle['price_ladder'][0]['back']; ?>"<?php endif; ?>  style="width: 100px;" >
							上限人数：<input type="text" class="layui-input" name="ladder_people[]"  <?php if(!empty($myarticle['price_ladder'])): ?>value="<?php echo $myarticle['price_ladder'][0]['people']; ?>"<?php endif; ?>  style="width: 100px;" >
							<a class="p_plus" href="javascript:;"><strong>[+]</strong></a>
						</div>
						<?php if(!(empty($myarticle['price_ladder']) || (($myarticle['price_ladder'] instanceof \think\Collection || $myarticle['price_ladder'] instanceof \think\Paginator ) && $myarticle['price_ladder']->isEmpty()))): if(is_array($myarticle['price_ladder']) || $myarticle['price_ladder'] instanceof \think\Collection || $myarticle['price_ladder'] instanceof \think\Paginator): $i = 0;$__LIST__ = is_array($myarticle['price_ladder']) ? array_slice($myarticle['price_ladder'],1,null, true) : $myarticle['price_ladder']->slice(1,null, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
							<div class="alisth">
								队伍编号：<input type="text" class="layui-input" style="width: 50px" name="ladder_num[]" value="<?php echo $vo['num']; ?>">
								抵达日期：<input type="text" class="layui-input" name="ladder_arrive[]" value="<?php echo $vo['arrive']; ?>"  style="width: 100px;" >&nbsp;
								游玩日期：<input type="text" class="layui-input" name="ladder_play[]" value="<?php echo $vo['play']; ?>"  style="width: 200px;" >&nbsp;
								返程时间：<input type="text" class="layui-input" name="ladder_back[]" value="<?php echo $vo['back']; ?>"  style="width: 100px;" >
								上限人数：<input type="text" class="layui-input" name="ladder_people[]" value="<?php echo $vo['people']; ?>"  style="width: 100px;" >
					...
					<script>
                        $(function(){
                            $('.p_plus').click(function() {
                                var html = "<div class='alisth' style='margin-bottom: 10px'>"
                                    + "队伍编号："
                                    + "<input type='text' class='layui-input' name='ladder_num[]' style='width: 50px;' value=''/>"
                                    + "&nbsp;&nbsp;抵达日期："
                                    + "<input type='text' class='layui-input' name='ladder_arrive[]' style='width: 100px;' value=''>"
										+"&nbsp;&nbsp;游玩时间："
										+"<input type='text' class='layui-input' name='ladder_play[]' style='width: 200px;' value=''>"
										+"&nbsp;&nbsp;返程时间："
										+"<input type='text' class='layui-input' name='ladder_back[]' style='width: 100px;' value=''>"
										+"&nbsp;&nbsp;上限人数："
										+"<input type='text' class='layui-input' name='ladder_people[]' style='width: 100px;' value=''>"
                                    + "<a class='p_plus' onclick='$(this).parent().remove();'>&nbsp;<strong>[-]</strong></a>"
                                    + "</div>";
                                $('#alisth_0').after(html);
                            });
				...
				<div class="layui-form-item">
					<label class="layui-form-label">限带儿童人数</label>
					<div class="layui-input-block">
						<input type="text" name="num"  autocomplete="off" class="layui-input" value="<?php if(!empty($myarticle['num'])): ?><?php echo $myarticle['num']; else: ?>0<?php endif; ?>" style="width: 50px" placeholder="最多2人">人
					</div>
				</div>
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						...
						<div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                            	<input type="text" name="remark"  autocomplete="off" class="layui-input" value="<?php if(!empty($myarticle['remark'])): ?><?php echo $myarticle['remark']; endif; ?>" >
							</div>
						</div>
