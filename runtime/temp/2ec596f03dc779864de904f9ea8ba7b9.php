<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"/home/wwwroot/yang.oioos.com/public/../application/back/view/user/userlist.html";i:1521165422;}*/ ?>
<!DOCTYPE html>
<html lang="en"><head>
	<meta charset="UTF-8">
	<title>个人信息</title>
			...
			<!--			<a class="layui-btn layui-btn-danger batchDel">批量删除</a>-->
                ...
                <div class="layui-form news_list">
					...
					<tbody class="news_content">
							...
							<td>
                                                            <a class="layui-btn layui-btn-mini" onclick="user_edit(<?php echo $vo['id']; ?>)"><i class="iconfont icon-edit"></i> 编辑</a>
								<a class="layui-btn layui-btn-normal layui-btn-mini" onclick="recharge(<?php echo $vo['id']; ?>)"><i class="layui-icon"></i> 余额充值</a>
