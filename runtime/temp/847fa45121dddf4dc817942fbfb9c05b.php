<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"/home/wwwroot/yang.oioos.com/public/../application/back/view/capital/commission_log.html";i:1523339776;}*/ ?>
<!DOCTYPE html>
<html lang="en"><head>
	<meta charset="UTF-8">
	<title>佣金明细</title>
		...
		<div class="layui-inline">
                    <div class="layui-input-inline">
                        <select name="search">
                          ...
                          <option value="prizeid" <?php if(!empty($query['query']['search']) && $query['query']['search']=='prizeid'): ?>selected=""<?php endif; ?>>用户ID</option>
                          <option value="ordersn" <?php if(!empty($query['query']['search']) && $query['query']['search']=='ordersn'): ?>selected=""<?php endif; ?>>订单号</option>
                        </select>
                    </div>
		    <div class="layui-input-inline">
			...
			<!--			<a class="layui-btn layui-btn-danger batchDel">批量删除</a>-->
                ...
                <div class="layui-form news_list">
					...
					<tbody class="news_content">
							...
							<td><?php echo $vo['username']; ?>(<?php echo $vo['prizeid']; ?>)</td>
                            <td>
