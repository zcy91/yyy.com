<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/home/wwwroot/yang.oioos.com/public/../application/back/view/user/addresslist.html";i:1519047698;s:73:"/home/wwwroot/yang.oioos.com/public/../application/back/view/refresh.html";i:1519047732;}*/ ?>
<!DOCTYPE html>
<html lang="en"><head>
	<meta charset="UTF-8">
	<title>个人信息</title>
		...
		<div class="layui-inline">
                    <div class="layui-input-inline">
                        <select name="search">
                          ...
                          <option value="uid" <?php if(!empty($query['query']['search']) && $query['query']['search']=='uid'): ?>selected=""<?php endif; ?>>uid</option>
                          <option value="phone" <?php if(!empty($query['query']['search']) && $query['query']['search']=='phone'): ?>selected=""<?php endif; ?>>手机号</option>
                        </select>
                    </div>
		    <div class="layui-input-inline">
...
<!--			<a class="layui-btn layui-btn-normal userAdd_btn">添加用户</a>-->
                ...
                <div class="layui-inline">
                    <a class="layui-btn " href="<?php if(!empty($query['query'])): ?><?php echo url('/back/set/export',array_merge(array('tablename'=>'address'),$query['query'])); else: ?><?php echo url('/back/set/export',array('tablename'=>'address')); endif; ?>" >导出Excel</a>
		</div>    
		<div class="layui-inline">
...
<!--							<th>操作</th>-->
					...
					<tbody class="news_content">
							...
							<td><?php echo $vo['detailed']; ?></td>
                                                        <td><?php if($vo['defaults']==1): ?>是<?php else: ?>否<?php endif; ?></td>
							<td>
                                                            <?php if(!empty($vo['time']))echo date("Y-m-d H:i",$vo['time']); ?>
                                                        </td>
							<!--<td>
