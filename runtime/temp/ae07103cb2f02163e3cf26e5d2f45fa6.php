<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/home/wwwroot/yang.oioos.com/public/../application/back/view/login/login.html";i:1510552886;}*/ ?>
<!DOCTYPE html>
<html lang="zh_cn">
<head>
    <meta charset="utf-8">
                    ...
                    <div class="beg-login-main">
                        <form class="layui-form layui-form-pane" method="post">
                            ...
                            <div class="layui-form-item">
                                ...
                                <input type="password"  name="pwd" lay-verify="required" placeholder="这里输入密码" value="" class="layui-input">
                            </div>
                            <div class="layui-form-item">
