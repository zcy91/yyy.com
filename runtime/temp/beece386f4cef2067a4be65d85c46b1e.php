<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/home/wwwroot/yang.oioos.com/public/../application/index/view/user/protocollist.html";i:1525327052;s:73:"/home/wwwroot/yang.oioos.com/public/../application/index/view/header.html";i:1526866272;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<body style="position:relative;">
    ...
    <div class="m-protocollist">
        ...
        <ul id="zengsong">
            ...
            <li>
                <a href="<?php echo url('/index/user/protocoldetail1',array('id'=>$v['id'])); ?>"><p style="width: 50%;overflow: hidden;white-space: nowrap;text-overflow: ellipsis"><?php echo $v['lambname']; ?>转让合同</p><span><?php echo date("Y-m-d H:i",$v['completetime']); ?></span></a>
            </li>
    ...
    border-radius: .1rem;" onclick="reset()">清除签名</button>
            ...
            <li>
                <a href="javascript:"><p style="text-align: center;float: unset">您还没有待签转让合同</p><span></span></a>
            </li>
            <?php endif; ?>
        </ul>
    </div>
