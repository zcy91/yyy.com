<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\wamp64\www\yyy.com\public/../application/index\view\index\love.html";i:1538038833;}*/ ?>
...
<!--<span id="span4" class="spanstyle">k</span><span id="span5" class="spanstyle">s</span><span id="span6" class="spanstyle"></span>-->
<!--<span id="span7" class="spanstyle">f</span><span id="span8" class="spanstyle">o</span><span id="span9" class="spanstyle">r</span>-->
<!--<span id="span10" class="spanstyle"> </span><span id="span11" class="spanstyle">your</span>-->
...
<div style="position: absolute;left: 60px;top:150px;color: palevioletred;font-size: 1.5rem">MARRY <span style="margin-left: 100px">ME</span></div>
<div id="contentToWrite" style="display:none">
    <br>
    <nb>一时间不知道从哪说起,         <br>
<nb><nb>真爱来了，我们要好好把握,不管面临多大的压力，<br>
<nb><nb><nb><nb>不管前面的路如何崎岖, 不管经历过什么,<br>
    <nb><nb><nb><nb>我仍坚信最浪漫的事就是和你一起慢慢变老.<br>
        <nb><nb><nb><nb><nb><nb>还记得,曾经的点点滴滴，从相识到现在，<br>
            <nb><nb><nb><nb><nb><nb><nb><nb>从谢绝到依赖,从生疏到相爱,<br>
<nb><nb><nb><nb><nb><nb><nb><nb><nb><nb>但求岁月静好,现世安稳.<br>
<nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb>不是简单而苍白的山盟海誓，<br>
<nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb>而是平淡日子同舟共济,相濡以沫.<br>
<nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb>相信下角的计时器,<br>
    <nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb>将永远继续下去,<br>
<nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb>直至数据溢出.<br>
    <nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb><nb>Yue.<br>
</div>
<script type="text/javascript">
    writeContent(true);
</script>
...
<!-- #bg -->
<div id="bg">
    <canvas id="garden" width="1583" height="2"><c style="color: #FFF; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:50px">你的浏览器过时了,试试火狐吧!</c></canvas>
</div>
