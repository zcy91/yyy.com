<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"E:\phpStudy\WWW\yyy.com\public/../application/back\view\admin\adminlist.html";i:1513734060;}*/ ?>
<!DOCTYPE html>
<html lang="en"><head>
	<meta charset="UTF-8">
	<title>个人信息</title>
	...
	<div class="larry-personal">
		...
		<div class="layui-inline">
		    ...
		    <div class="layui-input-inline">
                ...
                <div class="layui-inline">
                    <a class="layui-btn layui-btn-normal" onclick="admin_add()">添加管理员</a>
		</div>
		<div class="layui-inline">
                ...
                <div class="layui-form news_list">
					...
					<tbody class="news_content">
                                            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                <tr id="tr_<?php echo $vo['admin_id']; ?>">
							<td>
							...
							<td align="left"><?php echo $vo['admin_id']; ?></td>
							...
							<td>
                                                            <a class="layui-btn layui-btn-mini" onclick="admin_edit(<?php echo $vo['admin_id']; ?>)"><i class="iconfont icon-edit"></i> 编辑</a>
                                                            <a class="layui-btn layui-btn-danger layui-btn-mini" onclick="admin_del(<?php echo $vo['admin_id']; ?>)" data-id="1"><i class="layui-icon"></i> 删除</a>
							</td>
						</tr>
...
function admin_edit(id){
    var index = layui.layer.open({
            title : "修改用户",
            type : 2,
            content : "adminadd.html?admin_id="+id,
