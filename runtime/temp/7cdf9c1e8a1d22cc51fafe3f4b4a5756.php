<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\wamp64\www\yyy.com\public/../application/index\view\order\alipay_in_weixin.html";i:1534753996;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    if (location.hash.indexOf('error') != -1) {
        ...
        if (ua.indexOf('micromessenger') != -1) {
            ...
            var CURRENT_PAGE_URL = "<?php echo url('index/order/alipay_in_weixin'); ?>";
