<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\wamp64\www\yyy.com\public/../application/index\view\user\content.html";i:1533711248;s:66:"D:\wamp64\www\yyy.com\public/../application/index\view\header.html";i:1536904258;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<body id="activity-detail" class="zh_CN mm_appmsg not_in_mm">
                        ...
                        <ul class="">
                                <?php if(is_array($myarticle['img']) || $myarticle['img'] instanceof \think\Collection || $myarticle['img'] instanceof \think\Paginator): if( count($myarticle['img'])==0 ) : echo "" ;else: foreach($myarticle['img'] as $key=>$v2): ?>
                                        <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                            <a href="<?php echo $v2; ?>" data-size = <?php echo $myarticle['size'][$key][0]; ?>x<?php echo $myarticle['size'][$key][1]; ?> itemprop="contentUrl" >
                                                <div class="goods-pic" style="background-image: url(<?php echo $v2; ?>)"></div>
                                                <img src="<?php echo $v2; ?>" style="display: none" itemprop="thumbnail">
                                            </a>
                                        </figure>
    ...
    <div class="pswp" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div style="width:100%;background-color:#fff;height: 1rem">
            <p onclick="toupiao(<?php echo $myarticle['id']; ?>)" id="submit" >投票</p>
        </div>
...
//             window.location.href="<?php echo url('index/user/photograph'); ?>";
    ...
    $(".del_article").click(function () {
        ...
        }, function()
        {
            $.ajax({
                    type: "post",
                    url: "<?php echo url('index/user/del_article'); ?>",
                data: {
            "id":id
        },
            success : function(data){
