<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"D:\wamp64\www\yyy.com\public/../application/index\view\mall\mall.html";i:1520228804;s:66:"D:\wamp64\www\yyy.com\public/../application/index\view\header.html";i:1528532196;s:66:"D:\wamp64\www\yyy.com\public/../application/index\view\footer.html";i:1529485208;s:65:"D:\wamp64\www\yyy.com\public/../application/index\view\share.html";i:1526104824;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<body style="position:relative;">
    ...
    <div class="m-sphome">
        ...
        <div class="sphome-class">
            <ul>
                <li <?php if((!empty($order_bay) && $order_bay==1) or empty($order_bay)): ?> class="ahover" <?php endif; ?>onclick="javascript:location.href='<?php echo url('/index/mall/mall',array('order'=>1)); ?>'">默认</li>
                <li <?php if(!empty($order_bay) && $order_bay==2): ?> class="ahover"  <?php endif; ?>onclick="javascript:location.href='<?php echo url('/index/mall/mall',array('order'=>2)); ?>'">价格↓</li>
                <li <?php if(!empty($order_bay) && $order_bay==3): ?> class="ahover"  <?php endif; ?> onclick="javascript:location.href='<?php echo url('/index/mall/mall',array('order'=>3)); ?>'">价格↑</li>
            </ul>
        </div>
        <!--分类结束-->
        <!--产品列表-->
        <div class="sphome-prolist">
            <ul>
                <li class="ahover">
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>    
                    <div class="prolist-photo">
                        <a href="<?php echo url('/index/mall/malldetail',array('gid'=>$vo['id'])); ?>">
                            <img style="height: 2.5rem;" src="<?php if(!empty($vo['img'])) echo imgUrl($vo['img']);else echo imgUrl('') ?>" class="photo-img" />
                            <div class="photo-name"><?php echo $vo['gname']; ?></div>
                            <div class="photo-numb">
                                <span>积分：<u><?php echo $vo['price2']; ?></u></span>
                            </div>
                            <div class="photo-postage">
                                <span>包邮</span>
                                <u><?php echo $vo['sold']; ?>人已兑换</u>
                            </div>
                        </a>
                    </div>
