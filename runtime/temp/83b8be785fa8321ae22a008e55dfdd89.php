<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"E:\phpStudy\WWW\yyy.com\public/../application/back\view\user\pasture.html";i:1530519548;}*/ ?>
<!DOCTYPE html>
<html lang="en"><head>
    <meta charset="UTF-8">
    <title>牧场信息</title>
        ...
        <div class="layui-tab">
            <blockquote class="layui-elem-quote news_search">
                <form class="layui-form">
                    <div class="layui-inline">
                        <div class="layui-input-inline">
                            <select name="search">
                                ...
                                <option value="name" <?php if(!empty($query['query']['search']) && $query['query']['search']=='name'): ?>selected=""<?php endif; ?>>昵称</option>
                    ...
                    <div class="layui-inline">
                        <a class="layui-btn layui-btn-normal userAdd_btn1" onclick="pastureadd()">添加牧场</a>
                    </div>
            ...
            <td>
                ...
                <a class="layui-btn layui-btn-normal layui-btn-mini" onclick="xiaji(<?php echo $vo['id']; ?>)"><i class="layui-icon"></i> 下级</a>
   ...
   function pastureadd() {
       var index = layui.layer.open({
           ...
           success: function (layero, index) {
               setTimeout(function () {
                   layusi.layer.tips('点击此处返回牧场列表', '.layui-layer-setwin .layui-layer-close', {
                       tips: 3
                   });
               }, 500)
           }
