<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\wamp64\www\yyy.com\public/../application/back\view\goods\selllamblist.html";i:1535341002;}*/ ?>
<!DOCTYPE html>
<html lang="en"><head>
	<meta charset="UTF-8">
	<title>个人信息</title>
                ...
                <div class="layui-form news_list">
					...
					<thead>
						<tr>
							...
							<th  width="5%">ID</th>
							<th>申请串号</th>
                            <th>申请人/卖家/赠送人(ID)-(昵称)-(姓名)</th>
                            <th>类型</th>
							<th style="width: 30px!important;">金额</th>
							<th>买家id/受赠人id</th>
                            <th>旅游线路</th>
                            <th>旅游编号</th>
                            <th >剩余人数</th>
					...
					<tbody class="news_content">
                        ...
                        <tr id="tr_<?php echo $vo['id']; ?>">
							...
							<td><?php echo $vo['uid']; ?>-<?php echo $vo['username']; ?>-<?php echo $vo['realname']; ?></td>
                            <td>
							...
							<td style="width: 50"><?php echo $vo['money']; ?></td>
