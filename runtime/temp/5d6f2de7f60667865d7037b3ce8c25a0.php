<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/home/wwwroot/yang.oioos.com/public/../application/index/view/user/addaddress.html";i:1523007028;s:73:"/home/wwwroot/yang.oioos.com/public/../application/index/view/header.html";i:1526866272;}*/ ?>
<!DOCTYPE html>
<html>
<head>
                ...
                $.ajax({
                    ...
                    success: function(data){
                        if(data.type==1){
                            ...
                            //关闭后的操作
                            window.location.href='<?php echo url("/index/user/address"); ?>'
                            });
                        }else{
                            layer.msg(data.msg);
                        }
