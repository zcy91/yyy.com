<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"E:\phpStudy\WWW\yyy.com\public/../application/back\view\tuisong\tongzhi.html";i:1522216602;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<section class="layui-larry-box">
	<div class="larry-personal">
		<header class="larry-personal-tit">
			<span>推送通知 - 	(必填) [ 2小时内正在运行的所有APP（前台或后台运行的APP）会立即收到通知]</span>
		</header>
			...
			<form class="layui-form col-lg-5" action="" method="post">
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="title"  autocomplete="off" class="layui-input" value="<?php if(!empty($tuisong['title'])): ?><?php echo $tuisong['title']; endif; ?>"  placeholder="输入通知标题">
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">通知内容</label>
					<div class="layui-input-block">
						<textarea name="content" placeholder="输入通知内容" value="" class="layui-textarea"><?php if(!empty($tuisong['content'])): ?><?php echo $tuisong['content']; endif; ?></textarea>
					</div>
				</div>
		<header class="larry-personal-tit">
			<span>透传消息	- 	(选填，如果不透传数据请留空) [推送数据到APP]</span>
		</header>
				<div class="layui-form-item">
