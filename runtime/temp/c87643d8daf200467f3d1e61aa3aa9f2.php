<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\wamp64\www\yyy.com\public/../application/index\view\index\index.html";i:1533704768;s:66:"D:\wamp64\www\yyy.com\public/../application/index\view\header.html";i:1536904258;s:66:"D:\wamp64\www\yyy.com\public/../application/index\view\footer.html";i:1533704758;s:65:"D:\wamp64\www\yyy.com\public/../application/index\view\share.html";i:1534127867;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<body style="position:relative;">
    ...
    <div class="m-index">
        ...
        <!--轮播广告-->
        <div class="index-advimg">
            <!-- Swiper -->
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <?php if(is_array($ad) || $ad instanceof \think\Collection || $ad instanceof \think\Paginator): $i = 0; $__LIST__ = $ad;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <div class="swiper-slide" onclick="window.location.href='<?php echo $vo['site']; ?>';">
                        <img style="height: 3rem" alt="<?php echo $vo['title']; ?>" src="<?php if(!empty($vo['img'])) echo imgUrl($vo['img']);else echo imgUrl('') ?>" />
                    </div>
        ...
        <!--轮播广告结束-->
        <!--公告-->
        <div class="index-notice-v2">
            <span class="notice-title">公告</span>
            <ul class="notice-line">
                <?php if(!empty($fabu)): ?>
                    <li><a href="javascript:;"><?php echo $fabu['gname']; ?>已开售，仅剩<?php echo $fabu['stock']; ?>只，速来抢购！</a></li>
                <?php endif; if(!empty($isorder)): if(is_array($isorder) || $isorder instanceof \think\Collection || $isorder instanceof \think\Paginator): $i = 0; $__LIST__ = $isorder;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <li><a href="javascript:;">恭喜<?php if(!empty($vo['username'])): ?><?php echo $vo['username']; else: ?><?php echo $vo['realname']; endif; ?>认领食花百草羊成功，成为尊贵牧场主！</a></li>
                <?php endforeach; endif; else: echo "" ;endif; endif; if(is_array($notice) || $notice instanceof \think\Collection || $notice instanceof \think\Paginator): $i = 0; $__LIST__ = $notice;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <li><a href="<?php echo url('index/index/notice_detail',array('id'=>$vo['id'])); ?>"><?php echo $vo['title']; ?></a></li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
            <a href="<?php echo url('index/index/notice_list'); ?>" class="morenotice">更多<i class="fa fa-angle-right"></i></a>

        </div>
        <!--公告结束-->
        <!--用户信息-->
        <div class="index-usersum">
            <ul>
                <li class='first-list'>
                    <p class='usersum-note'>羊只出栏数</p>
                    <p class='usersum-mount'><?php echo $islambnum; ?>头</p>
                </li>
                <li class='mid-list'>
                    <p class='usersum-note'>羊只存栏数</p>
                    <p class='usersum-mount'><?php echo $yearlambnum; ?>头</p>
                </li>
                <li>
                    <p class='usersum-note'>注册牧场主</p>
                    <p class='usersum-mount'><?php echo $usernum; ?>人</p>
                </li>
            </ul>
        </div>
        <!--用户信息结束-->
            ...
            <div class="menuBox">
                <ul>
                    <li class='project-detail'>
                        <a href="<?php echo url('/index/discovery/content',array('id'=>14)); ?>">
                            <img src="/static/home/images/project-detail.png" />
                            <p>项目详情</p>
                        </a>
                    </li>
                    <li class='pasture-intro'>
                        <a href="<?php echo url('/index/discovery/pasture'); ?>">
                            <img src="/static/home/images/pasture-intro.png" />
                            <p>牧场介绍</p>
                        </a>
                    </li>
                    <li class='pasture-vido'>
                        <a href="<?php echo url('/index/discovery/sheepvideo'); ?>">
                            <img src="/static/home/images/pasture-vido.png" />
                            <p>牧场视频</p>
                        </a>
                    </li>
                    <li class='earn-money'>
                        <a href="<?php echo url('/index/shop/glist'); ?>">
                            <img src="/static/home/images/earn-money.png" />
                            <p>我要领养</p>
                        </a>
                    </li>
                    <li class='friend'>
                        <a href="<?php echo url('/index/user/invite'); ?>">
                            <img src="/static/home/images/friend.png" />
                            <p>邀请好友</p>
                        </a>
                    </li>
                    <li class='profit'>
                        <a href="<?php echo url('index/user/coupon'); ?>">
                            <img src="/static/home/images/profit.png" />
                            <p>福利优惠</p>
                        </a>
                    </li>
                    
                    <li class='about-us'>
                        <a href="<?php echo url('/index/discovery/index'); ?>">
                            <img src="/static/home/images/about-us.png" />
                            <p>了解我们</p>
                        </a>
                    </li>
                    <li class='question'>
                        <a href="<?php echo url('/index/discovery/questions'); ?>">
                            <img src="/static/home/images/question.png" />
                            <p>常见问题</p>
                        </a>
                    </li>
                </ul>
    ...
    <div class="m-footer">
                <ul>
            <li <?php if($controller=='index'): ?>class="ahover"<?php endif; ?>>
                <a href="<?php echo url('/index/index/index'); ?>">
                    <i class="fa fa-home"></i>
                    <p>我的牧场</p>
                </a>
            </li>
            <li <?php if($controller=='shop'): ?>class="ahover"<?php endif; ?>>
                <a href="<?php echo url('/index/shop/glist'); ?>">
                    <i class="fa fa-shopping-bag"></i>
                    <p>我要领养</p>
                </a>
            </li>
            <li <?php if($controller=='discovery'): ?>class="ahover"<?php endif; ?>>
                <a href="<?php echo url('/index/discovery/community'); ?>"> <!--<?php echo url('/index/discovery/index'); ?>-->
            ...
            <li <?php if($controller=='user'): ?>class="ahover"<?php endif; ?>>
                <a href="<?php echo url('/index/user/user'); ?>">
...
<!--<script type="text/javascript" src="//js.users.51.la/19421681.js"></script>-->
    ...
    <!--<div class="index-sum">
        <p>养殖总数</p>
        <span><a href="sheepfold.html"><u>15</u></a>只</span>
    </div>-->
    <!--养殖数结束-->
    <!--账户余额-->
    <!--<div class="index-money">
        <p>账户余额</p>
        <span><a href="wallet.html"><u>999999999.00</u></a>元</span>
    </div>-->
    <!--账户余额结束-->
