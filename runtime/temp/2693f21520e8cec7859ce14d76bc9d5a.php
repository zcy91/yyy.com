<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\wamp64\www\yyy.com\public/../application/index\view\user\agentlist.html";i:1533972008;s:66:"D:\wamp64\www\yyy.com\public/../application/index\view\header.html";i:1534386683;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<body style="position:relative;">
    ...
    <ul class="myorder-class">
        <li class="ahover">
            <a href="javascript:;"  onclick="getMyorder(1)">全部证书</a>
        </li>
        <li>
            <a href="javascript:;"  onclick="getMyorder(2)">生效证书</a>
        </li>
        <li>
            <a href="javascript:;"  onclick="getMyorder(3)">失效证书</a>
        </li>
    </ul>
    </div>
    <!--内容主体-->
    <div class="m-protocollist">
        <ul id="order">
            ...
            <li>
                <a href="<?php echo url('/index/user/agent',array('id'=>$vo['id'])); ?>"><p><?php echo $vo['lambname']; ?>——代理证书</p><span><?php echo date("Y-m-d H:i",$vo['addtime']); ?></span></a>
            </li>
            <?php endforeach; endif; else: echo "" ;endif; if(empty($list)): ?>
            <li>
                <a href="javascript:"><p>您还没有代理证书</p><span></span></a>
            </li>
            <?php endif; ?>
        ...
        <ul id="zengsong">
            ...
            <li>
                <a href="<?php echo url('/index/user/agent',array('id'=>$v['id'])); ?>"><p style="width: 50%;overflow: hidden;white-space: nowrap;text-overflow: ellipsis"><?php echo $v['lambname']; ?>——代理证书</p><span><?php echo date("Y-m-d H:i",$v['addtime']); ?></span></a>
            </li>
            <?php endforeach; endif; else: echo "" ;endif; if(empty($data)): ?>
            <li>
                <a href="javascript:"><p>您还没有生效的代理证书</p><span></span></a>
            </li>
            <?php endif; ?>
        </ul>
        <ul id="daiqian">
            ...
            <li>
                <a href="<?php echo url('/index/user/agent',array('id'=>$v1['id'])); ?>"><p style="width: 50%;overflow: hidden;white-space: nowrap;text-overflow: ellipsis"><?php echo $v1['lambname']; ?>——代理证书</p><span><?php echo date("Y-m-d H:i",$v1['addtime']); ?></span></a>
            </li>
            <?php endforeach; endif; else: echo "" ;endif; if(empty($arr)): ?>
            <li>
                <a href="javascript:"><p>您还没有失效的代理证书</p><span></span></a>
            </li>
            <?php endif; ?>
