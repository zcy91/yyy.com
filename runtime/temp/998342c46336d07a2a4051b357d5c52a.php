<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/home/wwwroot/yang.oioos.com/public/../application/back/view/article/articlelist.html";i:1519047808;s:73:"/home/wwwroot/yang.oioos.com/public/../application/back/view/refresh.html";i:1519047732;}*/ ?>
<!DOCTYPE html>
<html lang="en"><head>
	<meta charset="UTF-8">
	<title>个人信息</title>
...
<!--                        <div class="larry-side-menu" onclick="javascript:window.opener=null;window.open('','_self');window.close();" style="    position: absolute;    cursor: pointer;    z-index: 19490201;    right:  50px;    color: white;    text-align: center;    width: 30px;    height: 30px;    background-color: #FF0033;    line-height: 30px;    top: 6%;">
		...
		<div class="layui-inline">
		    ...
		    <div class="layui-input-inline">
                    ...
                    <div class="layui-inline">
			<a class="layui-btn layui-btn-normal"  onclick="article_add()">添加文章</a>
		</div>
					...
					<tbody class="news_content">
						...
						<tr  id="tr_<?php echo $vo['id']; ?>">
							...
							<td>
								...
								<a class="layui-btn layui-btn-normal layui-btn-mini "  onclick="comment_add(<?php echo $vo['id']; ?>)"><i class="layui-icon"></i> 评论</a>
...
function comment_add(id){
    var index = layui.layer.open({
            title : "添加评论",
            type : 2,
            content : "commentadd.html?aid="+id,
            success : function(layero, index){
                    setTimeout(function(){
                            layusi.layer.tips('点击此处返回用户列表', '.layui-layer-setwin .layui-layer-close', {
                                    tips: 3
