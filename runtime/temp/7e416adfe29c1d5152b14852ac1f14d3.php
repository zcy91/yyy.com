<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"E:\phpStudy\WWW\yyy.com\public/../application/back\view\set\contractset.html";i:1517818934;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	...
	<div class="larry-personal">
		...
		<div class="larry-personal-body clearfix">
			<form class="layui-form col-lg-5" action="" method="post">
				...
				<div class="layui-form-item">
					<label class="layui-form-label">领养期数</label>
					<div class="layui-input-block">
				...
				<div class="layui-form-item">
					<label class="layui-form-label">领养数量</label>
					<div class="layui-input-block">
				...
				<div class="layui-form-item">
					<label class="layui-form-label">领养金额</label>
					<div class="layui-input-block">
