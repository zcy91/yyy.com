<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"/home/wwwroot/yang.oioos.com/public/../application/back/view/addons/coupon.html";i:1523414388;}*/ ?>
<!DOCTYPE html>
<html lang="en"><head>
	<meta charset="UTF-8">
	<title>个人信息</title>
		...
		<div class="layui-inline">
                    <div class="layui-input-inline">
                        <select name="search">
                          ...
                          <option value="title" <?php if(!empty($query['query']['title']) && $query['query']['search']=='title'): ?>selected=""<?php endif; ?>>昵称</option>
                        </select>
                    </div>
		    <div class="layui-input-inline">
                ...
                <div class="layui-inline">
			<a class="layui-btn layui-btn-normal"   onclick="coupon_add()">添加优惠券</a>
		</div>
		<div class="layui-inline">
<!--			<a class="layui-btn layui-btn-danger batchDel">批量删除</a>-->
                ...
                <div class="layui-form news_list">
					...
					<tbody class="news_content">
							...
							<td><?php if($vo['backtype'] == 1): ?>打折&nbsp;&nbsp;<?php echo $vo['deduct']; ?>折<?php elseif($vo['backtype'] == 0): ?>立减&nbsp;&nbsp;<?php echo $vo['deduct']; ?>元<?php endif; ?></td>
													<?php if($vo['stime'] >0): ?><td><?php echo date("Y-m-d H:i",$vo['stime']); ?></td><?php else: ?><td>长期</td><?php endif; if($vo['etime'] > 0): ?><td><?php echo date("Y-m-d H:i",$vo['etime']); ?></td><?php else: ?><td>长期</td><?php endif; ?>
							<td><div class="<?php if($vo['status'] == 1): ?>layui-unselect layui-form-switch layui-form-onswitch<?php else: ?>layui-unselect layui-form-switch<?php endif; ?>"><i></i></div>
							</td>
							<td>
                                                            <a class="layui-btn layui-btn-mini" onclick="coupon_edit(<?php echo $vo['id']; ?>)"><i class="iconfont icon-edit"></i> 编辑</a>
