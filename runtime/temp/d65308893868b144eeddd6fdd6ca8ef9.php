<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"E:\phpStudy\WWW\yyy.com\public/../application/index\view\shop\glist.html";i:1529465950;s:68:"E:\phpStudy\WWW\yyy.com\public/../application/index\view\header.html";i:1528532196;s:68:"E:\phpStudy\WWW\yyy.com\public/../application/index\view\footer.html";i:1529485208;s:67:"E:\phpStudy\WWW\yyy.com\public/../application/index\view\share.html";i:1526104824;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<body style="position:relative;">
    ...
    <!--公共头部结束-->
    <!--内容主体-->
    <div class="m-buysheep" style='margin-bottom: 50px;'>
        <ul class="buysheep-list">
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <li class="<?php if($vo['stock']>0): ?>buyNow<?php else: ?>buyOverdue<?php endif; ?>">
                <!--标题-->
                <div class="buysheep-title">
                    <i class="fa fa-star title-icon"></i>
                    <p class="title-name"><?php echo $vo['gname']; ?></p>
                    <?php if($vo['stock']>0): ?><p class="title-time"><?php if(!empty($vo['shelftime'])) {echo date("Y-m-d H:i",$vo['shelftime']);}else{ echo date("Y-m-d H:i",$vo['creationtime']); } ?>开售</p><?php endif; if($vo['stock']>0): ?><p class="title-presell">预售</p><?php else: ?><p class="title-presell">售罄</p><?php endif; ?>
                    
                </div>
                <!--标题结束-->

                <!--转化率-->
                <div class="buysheep-rebate" style="display: none">
                    <p><span><?php echo $vo['percentage']; ?>%</span>预计年化收益率</p>
                </div>
                <!--转化率结束-->

                <!--商品价钱-->
                <div class="buysheep-money">
                    <div class="moneyBox">
                        <div class="money-numb"><i class="fa fa-yen"></i><span><?php echo $vo['price']; ?></span></div>
                        <div class="money-text">羊只单价</div>
                    </div>
                    <div class="moneyBox">
                        <div class="money-numb"><span><?php echo $vo['cycle']; ?></span><u>天</u></div>
                        <div class="money-text">养殖周期</div>
                    </div>
                    <div class="moneyBox">
                        <div class="money-numb"><span><?php echo $vo['stock']; ?></span><u>只</u></div>
                        <div class="money-text">剩余数量</div>
                    </div>
                </div>
                <!--商品价钱结束-->

                <!--购买按钮-->
                <?php if($vo['stock']>0 && $vo['shelftime']<=$time): ?><div class="buysheep-btn"><a href="<?php echo url('/index/shop/gdetails',array('id'=>$vo['id'])); ?>">点击领养</a></div>
                <?php elseif($vo['stock']>0 && $vo['shelftime']>$time): ?><div class="buysheep-btn"><a href="javascript:;">未开放</a></div>
                <?php else: ?><div class="buysheep-btn"><a href="javascript:;">已领完</a></div><?php endif; ?>
