<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"E:\phpStudy\WWW\yyy.com\public/../application/back\view\set\setting.html";i:1530942673;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	...
	<div class="larry-personal">
		...
		<div class="larry-personal-body clearfix">
			<form class="layui-form col-lg-5" action="" method="post">
				...
				<div class="layui-form-item">
					<label class="layui-form-label">默认收货时间</label>
					<div class="layui-input-block">
						<input type="number" name="delivery_time"  autocomplete="off" class="layui-input" value="<?php if(!empty($setting['delivery_time'])): ?><?php echo $setting['delivery_time']; endif; ?>"  placeholder="输入天数">
					</div>
				</div>
				<div class="layui-form-item">
