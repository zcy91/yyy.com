<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/home/wwwroot/yang.oioos.com/public/../application/back/view/goods/lambvideo.html";i:1519048060;s:73:"/home/wwwroot/yang.oioos.com/public/../application/back/view/refresh.html";i:1519047732;}*/ ?>
<!DOCTYPE html>
<html lang="en"><head>
	<meta charset="UTF-8">
	<title>个人信息</title>
...
<!--                        <div class="larry-side-menu" onclick="javascript:window.opener=null;window.open('','_self');window.close();" style="    position: absolute;    cursor: pointer;    z-index: 19490201;    right:  50px;    color: white;    text-align: center;    width: 30px;    height: 30px;    background-color: #FF0033;    line-height: 30px;    top: 6%;">
		...
		<div class="layui-inline">
		    ...
		    <div class="layui-input-inline">
                ...
                <div class="layui-inline">
			<a class="layui-btn layui-btn-normal"  onclick="video_add()">添加视频</a>
		</div>
                ...
                <div class="layui-form news_list">
					...
					<tbody class="news_content">
						...
						<tr id="tr_<?php echo $vo['id']; ?>">
							...
							<td>
                                                            <?php if($vo['status']==1): ?>
                                                            <button class="layui-btn layui-btn-danger layui-btn-mini">启用</button>
                                                            <?php elseif($vo['status']==0): ?>
                                                            <button class="layui-btn  layui-btn-mini">关闭</button>
                                                            <?php endif; ?>
							</td>
							<td>
                                                                <a class="layui-btn layui-btn-mini"   onclick="video_edit(<?php echo $vo['id']; ?>)"><i class="iconfont icon-edit"></i> 编辑视频</a>
								<a class="layui-btn layui-btn-danger layui-btn-mini"onclick="video_del(<?php echo $vo['id']; ?>)"  data-id="1"><i class="layui-icon"></i> 删除</a>
							</td>
						</tr>
