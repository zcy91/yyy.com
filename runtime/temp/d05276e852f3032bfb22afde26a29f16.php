<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/home/wwwroot/yang.oioos.com/public/../application/back/view/goods/goodslist.html";i:1523945292;s:73:"/home/wwwroot/yang.oioos.com/public/../application/back/view/refresh.html";i:1519047732;}*/ ?>
<!DOCTYPE html>
<html lang="en"><head>
	<meta charset="UTF-8">
	<title>个人信息</title>
		...
		<div class="layui-inline">
                    <div class="layui-input-inline">
                        <select name="search">
                          ...
                          <option value="gname" <?php if(!empty($query['query']['search']) && $query['query']['search']=='gname'): ?>selected=""<?php endif; ?>>商品名称</option>
                          <option value="price" <?php if(!empty($query['query']['search']) && $query['query']['search']=='price'): ?>selected=""<?php endif; ?>>价格</option>
                        </select>
                    </div>
		    <div class="layui-input-inline">
			...
			<a class="layui-btn layui-btn-normal "  onclick="goods_add()">添加商品</a>
                ...
                <div class="layui-inline">
                    <a class="layui-btn " href="<?php if(!empty($query['query'])): ?><?php echo url('/back/set/export',array_merge(array('tablename'=>'goods'),$query['query'])); else: ?><?php echo url('/back/set/export',array('tablename'=>'goods')); endif; ?>" >导出Excel</a>
		</div>
		<div class="layui-inline">
                ...
                <div class="layui-form news_list">
					...
					<tbody class="news_content">
						...
						<tr id="tr_<?php echo $vo['id']; ?>">
							...
							<td align="left"><?php echo $vo['gname']; ?></td>
							<td><?php echo $vo['type']; ?></td>
							<td><?php echo $vo['price']; ?></td>
							<td><?php echo $vo['stock']; ?></td>
                                                        <td><?php echo date("Y-m-d H:i",$vo['creationtime']); ?></td>
                                                        <td><?php if(!empty($vo['shelftime'])) echo date("Y-m-d H:i",$vo['shelftime']); ?></td>
							<td>
							...
							<td>
                                                            <a class="layui-btn layui-btn-mini" onclick="goods_edit(<?php echo $vo['id']; ?>)"><i class="iconfont icon-edit"></i> 编辑</a>
								<a class="layui-btn layui-btn-normal layui-btn-mini news_collect"><i class="layui-icon"></i> 收藏</a>
                                                                <a class="layui-btn layui-btn-danger layui-btn-mini " onclick="goods_del(<?php echo $vo['id']; ?>)" data-id="1"><i class="layui-icon"></i> 删除</a>
							</td>
						</tr>
