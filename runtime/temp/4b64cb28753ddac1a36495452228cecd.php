<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\wamp64\www\yyy.com\public/../application/back\view\article\articletype.html";i:1531711466;}*/ ?>
...
<div class="layui-btn-group">
    <button class="layui-btn" onclick="articletype_add()" >添加分类</button>
</div>
...
function articletype_add(){
 ...
 function articletype_edit(id){
    var index = layui.layer.open({
                title : "添加等级",
                type : 2,
                content : "articletypeadd.html?id="+id,
                success : function(layero, index){
                        setTimeout(function(){
                                layusi.layer.tips('点击此处返回分类列表', '.layui-layer-setwin .layui-layer-close', {
                                        tips: 3
