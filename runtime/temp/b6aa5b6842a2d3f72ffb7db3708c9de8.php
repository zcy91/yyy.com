<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"E:\phpStudy\WWW\yyy.com\public/../application/back\view\index\index.html";i:1530512625;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
					...
					<a href="javascript:;">
					   ...
					   <em class="layui-nav-more"></em>
					    ...
					    <dl class="layui-nav-child">
							...
							<dd  <?php echo module_display('user&agentlist',$power,$admininfo['level_id']); ?>>
							<a href="javascript:;" data-url="user/pasture">
								<i class="iconfont icon-diannao1" data-icon='icon-diannao1'></i>
								<span>牧场管理</span>
							</a>
							</dd>
