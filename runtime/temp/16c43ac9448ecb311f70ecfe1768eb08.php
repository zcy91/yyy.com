<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\wamp64\www\yyy.com\public/../application/back\view\user\userlist.html";i:1536300196;}*/ ?>
<!DOCTYPE html>
<html lang="en"><head>
	<meta charset="UTF-8">
	<title>个人信息</title>
		...
		<div class="layui-inline">
                    <div class="layui-input-inline">
                        <select name="search">
                          ...
                          <option value="username" <?php if(!empty($query['query']['search']) && $query['query']['search']=='username'): ?>selected=""<?php endif; ?>>昵称</option>
                          <option value="mobile" <?php if(!empty($query['query']['search']) && $query['query']['search']=='mobile'): ?>selected=""<?php endif; ?>>手机号</option>
                        </select>
                    </div>
		    <div class="layui-input-inline">
			...
			<!--			<a class="layui-btn layui-btn-danger batchDel">批量删除</a>-->
                ...
                <div class="layui-form news_list">
					...
					<tbody class="news_content">
							...
							<!--<td><?php if($vo['sex']==2): ?>女<?php else: ?>男<?php endif; ?></td>-->
							<td><?php echo $vo['credit']; ?></td>
							<td><?php echo $vo['credit2']; ?></td>
							<th><a class="layui-btn layui-btn-normal layui-btn-mini" onclick="address(<?php echo $vo['id']; ?>)">点击查看</a></th>
                            <td><?php echo date("Y-m-d H:i",$vo['reg_time']); ?></td>
							<td>
								<div class="<?php if($vo['status'] == 0): ?>layui-unselect layui-form-switch layui-form-onswitch<?php else: ?>layui-unselect layui-form-switch<?php endif; ?>"><i></i></div>
							</td>
							<td>
								<a class="layui-btn layui-btn-mini" style="margin-left: 10px" onclick="user_edit(<?php echo $vo['id']; ?>)"><i class="iconfont icon-edit"></i> 编辑</a>
								<a class="layui-btn  layui-btn-mini" style="background-color: #0aba07" onclick="exchange(<?php echo $vo['id']; ?>)"><i class="layui-icon-exchange"></i>兑换</a>
...
function address(id){
    var index = layui.layer.open({
            title : "地址列表",
            type : 2,
            content : "addresslist.html?search=uid&keyword="+id,
            success : function(layero, index){
                    setTimeout(function(){
                            layusi.layer.tips('点击此处返回用户列表', '.layui-layer-setwin .layui-layer-close', {
                                    tips: 3
