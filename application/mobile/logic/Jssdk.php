...
// 随机字符串
 ...
 public function get_access_token(){
    ...
    public function push_msg_news($openid,$content){
        $access_token = $this->get_access_token();
        //var_dump($access_token);die;
        $url ="https://api.weixin.qq.com/cgi-bin/message/custom/send?access_token={$access_token}";
        $post_arr = array(
            ...
            'msgtype'=>'news',
            'news'=>array(
                'articles'=>array('title'=>$content,'description'=>'食花百草羊','url'=>'http://yang.oioos.com','picurl'=>'https://img-blog.csdn.net/20151123180058208?imageView2/5/w/120/h/120')
            )
        );
        $post_str = json_encode($post_arr,JSON_UNESCAPED_UNICODE);
//        var_dump($post_str);die;
        $post_str='{"touser":"otsEpwJ0_RmPkz_sk7BgAmKCOKu4","msgtype":"news","news":{"articles":[{"title":"食花百草羊","description":"食花百草羊","url":"http:\/\/www.baidu.com","picurl":"http:\/\/yang.oioos.com\/server\/upload\/20180209\/20180209092234362.jpg"}]}}';
        //var_dump($post_str);die;
        $return = httpRequest($url,'POST',$post_str);
