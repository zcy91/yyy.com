...
$mchid = '1487835822';          //微信支付商户号 PartnerID 通过微信支付商户资料审核后邮件发送
$appid = 'wx39eef0e1655086aa';  //微信支付申请对应的公众号的APPID
$appKey = '7ba300bf667b52a21d32076f78fc665f';   //微信支付申请对应的公众号的APP Key
$apiKey = 'lijing1118lijing1118lijing1118li';   //https://pay.weixin.qq.com 帐户设置-安全设置-API安全-API密钥-设置API密钥
//①、获取用户openid
$wxPay = new Jsapi($mchid,$appid,$appKey,$apiKey);
...
$orderName = '支付测试';    //订单标题
$notifyUrl = "http://yang.oioos.com/index/wxpay/wx_notify";   //付款成功后的回调地址(不要有问号)
$payTime = time();      //付款时间
